...
$mob = $_POST['mobileno'];
		...
		$headers .= 'From: ERP International<info@aerpint.com>' . "\r\n";
				
		//$headers .= 'Bcc: anagaraju.001@gmail.com' . "\r\n";
		$headers .= 'Bcc: info@aerpint.com' . "\r\n";
		$headers .= 'Bcc: erp@aerpint.com' . "\r\n";
